...
## Login:
Here we are going to test if all the code in login works.

- firstly we import two junits methods to allow us to use @Test and assertTrue/False to test the methods 
- basically login test consists of methods that check password vallidation,phone number validation and User name validation.
- It also checks the process to login and register of the user details/information.

That will be all for my project thank you.
